...
export interface AntGridProps {
    ...
    onSelectedRow?: (selectedKeys: any) => void;
    rowKey:string;
}
...
class AntGrid extends React.Component<AntGridProps, any> {
    constructor(props: any) {
        ...
        var operationMode = "serverSidePerRow";
        if(this.props.operationMode){
            operationMode = this.props.operationMode;
        }
          
        var operationColumnTitle = "Operations";
        if(this.props.operationColumnTitle)
        {
            operationColumnTitle = this.props.operationColumnTitle;
        }

        this.state = { dataTable: [], loading: false, selectedRowKeys: [], editingKey: '', newRowCount: 0, collapseKey: '1', operationColumnTitle: operationColumnTitle, operationMode:operationMode};
    ...
    Search = (e:any) => {
        ...
        fetch(this.props.searchActionUrl, requestOptions)
    ...
    handleAdd = () => {
        ...
        const newData = {key: newKey, RowStatus:"New"};
        this.setState({
